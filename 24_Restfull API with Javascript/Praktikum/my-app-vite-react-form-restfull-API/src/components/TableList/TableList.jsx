...
import { deleteProducts } from "../../configs/redux/product/productThunk";
// import { getProduct, deleteProduct } from "../../configs/redux/product/productThunk";

const TableList = ({products, handleDelete}) => {
                ...
                <tr key={idx}>
                  ...
                  <td scope="col">
                    ...
                    <button
                      ...
                      // }}
                    >
                      <Link to={`/editproduct/${products.uuid}`}>
                      Edit
                      </Link>
                    </button>
                  </td>
                  <td scope="col">
                    <Link to={`/detailproduct/${products.uuid}`}>View {idx + 1}</Link>
                  </td>
                </tr>
              );
            })}
